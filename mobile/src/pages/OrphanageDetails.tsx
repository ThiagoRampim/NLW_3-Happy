...
interface OrphanageDetailsRouteParans {
  id: number;
}
...
export default function OrphanageDetails() {
  ...
  const parans = route.params as OrphanageDetailsRouteParans;
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            ...
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>Segundas à sextas das {orphanage.opening_hours}</Text>
          </View>
