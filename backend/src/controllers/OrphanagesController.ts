...
export default {
    ...
    async create(request: Request, response: Response) {
        ...
        const schema = Yup.object().shape({
            ...
            instructions: Yup.string().required("Campo instrução obrigatório"),
            opening_hours: Yup.string().required("Campo horário de abertura obrigatório"),
            open_on_weekends: Yup.boolean().required("Campo abre aos finais de semana? obrigatório"),
            images: Yup.array(
                Yup.object().shape({
